...
$$f\colon \mathbb{R}^k\times\mathbb{R}^p\to\mathbb{R}^m, \quad (u,\eta)\mapsto f_{\eta}(u)$$
...
In summary, :mod:`ml_adp.mapping` (and its submodules) contain callables with signature ``(input_, param)``, implementing functions $(u,\eta)\mapsto f_{\eta}(u)$ primarily to be considered variates in their first argument and, as such, understood to be parametrized by their second argument.
"""
